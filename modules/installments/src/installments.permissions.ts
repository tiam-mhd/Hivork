...
export const INSTALLMENTS_PERMISSION_CODES = [
  ...
  'installments.installment.penalty',
  'installments.installment.discount',
  'installments.installment.reschedule',
  'installments.installment.defer',
  'installments.installment.accelerate',
  'installments.installment.regenerate',
  'installments.installment.merge',
  'installments.installment.split',
  'installments.payment.view',
  'installments.payment.read',
  'installments.payment.confirm',
  'installments.payment.reject',
  'installments.payment.void',
  'installments.payment.refund',
  'installments.settlement.manage',
  'installments.reconciliation.manage',
  'installments.check.create',
  'installments.check.read',
  'installments.check.bounce',
  'installments.check.collect',
  'installments.check.transfer',
  'installments.check.update',
  'installments.payment.receipt.send',
...
export const INSTALLMENTS_PERMISSION_DESCRIPTIONS: Record<InstallmentsPermissionCode, string> = {
  ...
  'installments.installment.reschedule': 'جابجایی تاریخ سررسید قسط',
  'installments.installment.defer': 'تعویق قسط',
  'installments.installment.accelerate': 'تعجیل سررسید قسط',
  'installments.installment.regenerate': 'بازتولید اقساط قرارداد',
  'installments.installment.merge': 'ادغام اقساط',
  'installments.installment.split': 'تقسیم قسط',
  ...
  'installments.reconciliation.manage': 'مدیریت مغایرت‌گیری',
  'installments.check.create': 'ثبت چک',
  'installments.check.read': 'مشاهده چک‌ها',
  'installments.check.bounce': 'ثبت برگشت چک',
  'installments.check.collect': 'وصول چک',
  'installments.check.transfer': 'انتقال چک',
  'installments.check.update': 'ویرایش پیگیری و تصویر چک',
